(function () {
  ...
  trigger.innerHTML = `<svg viewBox="0 0 766 563" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path data-color="#6D1628" fill="#6D1628"/>
    <path data-color="#53C085" fill="#53C085"/>
    <path data-color="#4990CB" fill="#4990CB"/>
    <path data-color="#F2726C" fill="#F2726C"/>
    <path data-color="#FCCBCF" fill="#FCCBCF"/>
    <path data-color="#FDF100" fill="#FDF100"/>
